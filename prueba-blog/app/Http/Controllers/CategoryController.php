...
class CategoryController extends Controller
{
     ...
     * @param  int  $id
     * @return \Illuminate\Http\Response
     *  findOrFail() de los modelos de Laravel es muy usado en los     controladores ya que nos permite recuperar un registro de un modelo a partir de su ID sin necesidad de comprobar si existe.
     *
     */
