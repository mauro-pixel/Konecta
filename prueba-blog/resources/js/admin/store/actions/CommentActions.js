...
function listComments(page) {
    return function(dispatch, getState) {
        ...
        Comment.list(page)
            .then(response =>
                dispatch({
                    type: CommentTypes.LIST_COMMENTS_SUCCESS,
                    data: response.data.data
                })
            )
            .catch(error =>
                dispatch({
                    type: CommentTypes.LIST_COMMENTS_FAILURE,
...
function editComment(payload, id, cb = null) {
    return function(dispatch, getState) {
        ...
        Comment.edit(payload, id)
            .then(response => {
                dispatch({
                    type: CommentTypes.EDIT_COMMENTS_SUCCESS,
                    data: response.data,
                    id
                });
            ...
            .catch(error =>
                dispatch({
                    type: CommentTypes.EDIT_COMMENTS_FAILURE,
                    error: error.response.data,
                    id
                })
            );
...
function deleteComment(id) {
    return function(dispatch, getState) {
        ...
        Comment.remove(id)
            .then(response =>
                dispatch({
                    type: CommentTypes.DELETE_COMMENTS_SUCCESS,
            ...
            .catch(error =>
                dispatch({
                    type: CommentTypes.DELETE_COMMENTS_FAILURE,
                    error: error.response.data
                })
            );
    };
...
export { listComments, editComment, deleteComment };
