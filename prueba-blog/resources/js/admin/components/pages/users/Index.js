                        ...
                        <div className="col-md-12">
                            <div className="box">
                                ...
                                <div className="box-body">
                                    <Spinner
                                        show={this.props.user.list_spinner}
                                    />

                                    <SuccessAlert
                                        msg={this.props.user.success_message}
                                    />
                                    <ErrorAlert
                                        msg={this.props.user.error_message}
                                    />
                                    ...
                                    <table className="table">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>Email</th>
                                                <th>Admin</th>
                                                <th width="15%">Accciones</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            {this.props.user.users.data
                                                ? this.props.user.users.data.map(
                                                      item => (
                                                          <Row
                                                              key={item.id}
                                                              user={item}
                                ...
                                <Pagination
                                    ...
                                    onclick={this.props.listUsers.bind(this)}
                                />
                            </div>
                        </div>
                    </div>
