    ...
    render() {
        return (
            <div className="content-wrapper">
                    ...
                    <div className="row">
                        ...
                        >
                            <PostForm
                                ...
                                success_message={
                                    this.props.post.success_message
                                }
                                ...
                                openAddCategoryModal={this.openAddCategoryModal.bind(
                                    this
                                )}
                                openAddTagModal={this.openAddTagModal.bind(
                                    this
                                )}
                                handleSave={this.handleSave}
                                submitRef={this.submitRef}
                                validation_errors={
                                    this.props.post.validation_errors
                                }
                            />
                        </form>
                    </div>
                ...
                <AddCategoryModal
                    show_modal={this.state.show_add_category_modal}
                    close_modal={this.closeAddCategoryModal.bind(this)}
                />

                <AddTagModal
                    show_modal={this.state.show_add_tag_modal}
                    close_modal={this.closeAddTagModal.bind(this)}
                />
            </div>
        );
    }
